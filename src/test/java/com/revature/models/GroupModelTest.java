...
class GroupModelTest {
	...
	void init() {
		...
		group1 = new Group(GROUP_ID, GROUP_NAME,GROUP_IMGURL,GROUP_COVER, owner, members);
		group2 = new Group(GROUP_ID, GROUP_NAME,GROUP_IMGURL,GROUP_COVER, owner, members);
	}
